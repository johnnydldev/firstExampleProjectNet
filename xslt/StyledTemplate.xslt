    ...
    <html lang="en">
      ...
      <head>
        ...
        <script>
          ...
          const mapOptions = {
          center: { lat: -34.397, lgt: 150.644 },  // Cambia estas coordenadas por las deseadas
          zoom: 8
          };
        ...
        <!--End upload reference of Google API-->

        <!--Reference to my file JS-->
        ...
        <link rel="stylesheet" href="assets/css/DragAndDrop.css"></link>
        ...
        <main id="main">
          ...
          <section class="contact" id="Contacto">
            ...
            <div data-aos="fade-up">
              ...
              <text id="direction">Dirección de un lugar ...</text>
          ...
          <section id="PlayRoom" class="d-flex align-items-center">
            ...
            <div class="container">
              ...
              <!--Drag and drop-->
              <section class="tm-section-row p-5">
                <h2><![CDATA[Drag & Drop]]></h2>
                <div id="cuadro1" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return drop(event)" ondragend="end(event)">

                  <div class="cuadradito" id="arrastrable1" draggable="true" ondragstart="start(event)"></div>
                  <div class="cuadradito" id="arrastrable2" draggable="true" ondragstart="start(event)"></div>
                  <div class="cuadradito" id="arrastrable3" draggable="true" ondragstart="start(event)"></div>

                </div>
                <!--End first square-->

                <div id="cuadro2" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)">
                </div>
                <!--End second square-->

                <div id="cuadro3" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return clone(event)">
                </div>
                <!--End third square-->

                <div id="papelera" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return remove(event)">
                </div>
                <!--End four square-->
